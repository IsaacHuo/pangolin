...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "agent-shield", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for AgentShield. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("AgentShield Issue Label Audit");
