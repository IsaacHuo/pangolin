...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof AgentShieldConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: AgentShieldConfig; env: NodeJS.ProcessEnv }): {
  cfg: AgentShieldConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
