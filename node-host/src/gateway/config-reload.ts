...
import type { AgentShieldConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: AgentShieldConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: AgentShieldConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: AgentShieldConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: AgentShieldConfig) => void;
  log: {
