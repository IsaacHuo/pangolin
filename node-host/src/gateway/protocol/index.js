...
export const validateAgentsToolsGetParams = ajv.compile(AgentsToolsGetParamsSchema);
export const validateAgentsToolsSetParams = ajv.compile(AgentsToolsSetParamsSchema);
