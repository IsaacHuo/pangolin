...
import { type AgentShieldConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: AgentShieldConfig): string[] {
...
export function listAgentsForGateway(cfg: AgentShieldConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: AgentShieldConfig): string {
...
function resolveSessionStoreAgentId(cfg: AgentShieldConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: AgentShieldConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: AgentShieldConfig): GatewaySessionsDefaults {
