...
export type AgentShieldHookMetadata = {
  always?: boolean;
  hookKey?: string;
  emoji?: string;
  homepage?: string;
...
export type Hook = {
  name: string;
  description: string;
  source: "agent-shield-bundled" | "agent-shield-managed" | "agent-shield-workspace" | "agent-shield-plugin";
  pluginId?: string;
...
export type HookEntry = {
  ...
  metadata?: AgentShieldHookMetadata;
