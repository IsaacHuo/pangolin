...
import type { AgentShieldPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: AgentShieldPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: AgentShieldPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
