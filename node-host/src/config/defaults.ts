...
function resolveAnthropicDefaultAuthMode(cfg: AgentShieldConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: AgentShieldConfig): AgentShieldConfig {
...
export function applyTalkApiKey(config: AgentShieldConfig): AgentShieldConfig {
...
export function applyModelDefaults(cfg: AgentShieldConfig): AgentShieldConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: AgentShieldConfig): AgentShieldConfig {
...
export function applyLoggingDefaults(cfg: AgentShieldConfig): AgentShieldConfig {
...
export function applyContextPruningDefaults(cfg: AgentShieldConfig): AgentShieldConfig {
...
export function applyCompactionDefaults(cfg: AgentShieldConfig): AgentShieldConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
