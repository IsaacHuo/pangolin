import type { AgentShieldConfig } from "./config.js";
...
function isTelegramConfigured(cfg: AgentShieldConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: AgentShieldConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: AgentShieldConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: AgentShieldConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: AgentShieldConfig): boolean {
...
function isIMessageConfigured(cfg: AgentShieldConfig): boolean {
...
function isWhatsAppConfigured(cfg: AgentShieldConfig): boolean {
...
function isGenericChannelConfigured(cfg: AgentShieldConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: AgentShieldConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: AgentShieldConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: AgentShieldConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: AgentShieldConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: AgentShieldConfig, pluginId: string): AgentShieldConfig {
...
function registerPluginEntry(cfg: AgentShieldConfig, pluginId: string): AgentShieldConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
