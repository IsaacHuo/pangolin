...
function resolveWatchPaths(workspaceDir: string, config?: AgentShieldConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: AgentShieldConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: AgentShieldConfig }) {
