...
const CLEANUP_STATE_KEY = Symbol.for("agent-shield.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("agent-shield.sessionWriteLockHeldLocks");
