...
import { assertRequiredParams, CLAUDE_PARAM_GROUPS, createAgentShieldReadTool, createSandboxedEditTool, createSandboxedReadTool, createSandboxedWriteTool, normalizeToolParams, patchToolSchemaForClaudeCompatibility, wrapToolWorkspaceRootGuard, wrapToolParamNormalization, } from "./pi-tools.read.js";
...
export function createAgentShieldCodingTools(options) {
    ...
    const base = codingTools.flatMap((tool) => {
        if (tool.name === readTool.name) {
            ...
            const wrapped = createAgentShieldReadTool(freshReadTool);
