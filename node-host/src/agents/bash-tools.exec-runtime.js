...
export const DEFAULT_PENDING_MAX_OUTPUT = clampWithDefault(readEnvInt("AGENT_SHIELD_BASH_PENDING_MAX_OUTPUT_CHARS"), 30_000, 1_000, 200_000);
...
export async function runExecProcess(opts) {
    ...
    const promise = managedRun
        ...
        const status = exit.exitCode === 0 && exit.reason === "exit" ? "completed" : "failed";
