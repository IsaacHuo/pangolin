...
export const DEFAULT_SANDBOX_IMAGE = "agent-shield-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "agent-shield-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "agent-shield-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "agent-shield-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "agent-shield-sbx-browser-";
