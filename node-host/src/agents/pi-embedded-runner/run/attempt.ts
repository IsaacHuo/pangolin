...
// Signal and Telegram imports removed
import { buildTtsSystemPromptHint } from "../../../tts/tts.js";
import { resolveUserPath } from "../../../utils.js";
import { normalizeMessageChannel } from "../../../utils/message-channel.js";
import { isReasoningTagProvider } from "../../../utils/provider-utils.js";
import { resolveAgentShieldAgentDir } from "../../agent-paths.js";
...
import { resolveAgentShieldDocsPath } from "../../docs-path.js";
...
import { createAgentShieldCodingTools } from "../../pi-tools.js";
...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    const agentDir = params.agentDir ?? resolveAgentShieldAgentDir();

    // Check if the model supports native image input
    const modelHasVision = params.model.input?.includes("image") ?? false;
    const toolsRaw = params.disableTools
      ? []
      : createAgentShieldCodingTools({
          exec: {
    ...
    let runtimeCapabilities = runtimeChannel
      ...
      : undefined;
    if (false /* Removed Telegram logic */ && params.config) {
      // Logic removed
    }
    ...
    const promptMode =
      isSubagentSessionKey(params.sessionKey) || isCronSessionKey(params.sessionKey)
        ? "minimal"
        : "full";
    const docsPath = await resolveAgentShieldDocsPath({
      workspaceDir: effectiveWorkspace,
    ...
    try {
      ...
      try {
        ...
        // double-compaction. See: https://github.com/agent-shield/agent-shield/issues/9282
      ...
      // See: https://github.com/agent-shield/agent-shield/issues/8643
      await flushPendingToolResultsAfterIdle({
        agent: session?.agent,
        sessionManager,
      });
