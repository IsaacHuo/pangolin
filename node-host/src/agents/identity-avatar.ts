...
function resolveAvatarSource(cfg: AgentShieldConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: AgentShieldConfig, agentId: string): AgentAvatarResolution {
