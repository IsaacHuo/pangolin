...
import { createSessionVisibilityGuard, createAgentToAgentPolicy, classifySessionKind, deriveChannel, resolveDisplaySessionKey, resolveEffectiveSessionToolsVisibility, resolveInternalSessionKey, resolveSandboxedSessionToolContext, stripToolMessages, } from "./sessions-helpers.js";
        ...
        execute: async (_toolCallId, args) => {
            ...
            for (const entry of sessions) {
                ...
                if (sessionId && storePath) {
                    try {
                        transcriptPath = resolveSessionFilePath(sessionId, sessionFile ? { sessionFile } : undefined, {
