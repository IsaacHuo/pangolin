...
export function resolveSessionToolsVisibility(cfg: AgentShieldConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: AgentShieldConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: AgentShieldConfig): AgentToAgentPolicy {
