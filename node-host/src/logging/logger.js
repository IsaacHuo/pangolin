...
import { resolvePreferredAgentShieldTmpDir } from "../infra/tmp-agent-shield-dir.js";
import { readLoggingConfig } from "./config.js";
import { levelToMinLevel, normalizeLogLevel } from "./levels.js";
import { loggingState } from "./state.js";
export const DEFAULT_LOG_DIR = resolvePreferredAgentShieldTmpDir();
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "agent-shield.log"); // legacy single-file path
...
function resolveSettings() {
    ...
    const defaultLevel = process.env.VITEST === "true" && process.env.AGENT_SHIELD_TEST_FILE_LOG !== "1"
        ? "silent"
        : "info";
