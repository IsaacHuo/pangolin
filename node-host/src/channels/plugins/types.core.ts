...
export type ChannelAgentToolFactory = (params: { cfg?: AgentShieldConfig }) => ChannelAgentTool[];
...
export type ChannelMentionAdapter = {
  stripPatterns?: (params: {
    ctx: MsgContext;
    cfg: AgentShieldConfig | undefined;
    agentId?: string;
  }) => string[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: AgentShieldConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: AgentShieldConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: AgentShieldConfig }) => boolean;
  supportsCards?: (params: { cfg: AgentShieldConfig }) => boolean;
