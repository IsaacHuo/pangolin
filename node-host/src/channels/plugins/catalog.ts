...
import type { AgentShieldPackageManifest } from "../../plugins/manifest.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { ChannelMeta } from "./types.js";
import { MANIFEST_KEY } from "../../compat/legacy-names.js";
import { discoverAgentShieldPlugins } from "../../plugins/discovery.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, AgentShieldPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["AGENT_SHIELD_PLUGIN_CATALOG_PATHS", "AGENT_SHIELD_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<AgentShieldPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: AgentShieldPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: AgentShieldPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverAgentShieldPlugins({ workspaceDir: options.workspaceDir });
