...
export type PromptAccountIdParams = {
  ...
  label: string;
  currentId?: string;
  listAccountIds: (cfg: AgentShieldConfig) => string[];
...
export type ChannelOnboardingDmPolicy = {
  ...
  policyKey: string;
  allowFromKey: string;
  getCurrent: (cfg: AgentShieldConfig) => DmPolicy;
  setPolicy: (cfg: AgentShieldConfig, policy: DmPolicy) => AgentShieldConfig;
...
export type ChannelOnboardingAdapter = {
  ...
  disable?: (cfg: AgentShieldConfig) => AgentShieldConfig;
};
