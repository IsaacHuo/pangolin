...
export function listBindings(cfg: AgentShieldConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: AgentShieldConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: AgentShieldConfig) {
