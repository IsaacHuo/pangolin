...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/agent-shield/agent-shield/issues/15692
   */
  delivered?: boolean;
};
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.AGENT_SHIELD_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.agent-shield/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: AgentShieldConfig = {
    ...params.cfg,
