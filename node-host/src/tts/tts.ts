...
export function resolveTtsConfig(cfg: AgentShieldConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.AGENT_SHIELD_TTS_PREFS?.trim();
  if (envPath) {
...
export function buildTtsSystemPromptHint(cfg: AgentShieldConfig): string | undefined {
