...
export function isCommandEnabled(cfg: AgentShieldConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: AgentShieldConfig): {
  provider: string;
  model: string;
} {
  const resolved = resolveConfiguredModelRef({
    cfg: cfg ?? ({} as AgentShieldConfig),
...
export function getCommandDetection(_cfg?: AgentShieldConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: AgentShieldConfig) {
