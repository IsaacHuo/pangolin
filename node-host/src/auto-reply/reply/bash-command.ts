...
function resolveForegroundMs(cfg: AgentShieldConfig): number {
...
export async function handleBashChatCommand(params: {
  ...
  if (params.cfg.commands?.bash !== true) {
    return {
      text: "⚠️ bash is disabled. Set commands.bash=true to enable. Docs: https://docs.agent-shield.ai/tools/slash-commands#config",
    };
  }
