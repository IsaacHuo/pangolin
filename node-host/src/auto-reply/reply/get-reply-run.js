...
import { resolveGroupSessionKey, resolveSessionFilePath, resolveSessionFilePathOptions, updateSessionStore, } from "../../config/sessions.js";
...
export async function runPreparedReply(params) {
    ...
    const sessionFile = resolveSessionFilePath(sessionIdFinal, sessionEntry, resolveSessionFilePathOptions({ agentId, storePath }));
