...
export async function prependSystemEvents(params: {
  ...
  const resolveSystemEventTimezone = (cfg: AgentShieldConfig) => {
  ...
  const formatSystemEventTimestamp = (ts: number, cfg: AgentShieldConfig) => {
...
export async function ensureSkillSnapshot(params: {
  ...
  if (process.env.AGENT_SHIELD_TEST_FAST === "1") {
