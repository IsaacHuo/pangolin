...
export const A2UI_PATH = "/__agent-shield__/a2ui";

export const CANVAS_HOST_PATH = "/__agent-shield__/canvas";

export const CANVAS_WS_PATH = "/__agent-shield__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.agentShieldCanvasA2UIAction.postMessage(...)
  // - Android: window.agentShieldCanvasA2UIAction.postMessage(...)
  const handlerNames = ["agentShieldCanvasA2UIAction"];
  ...
  globalThis.AgentShield = globalThis.AgentShield ?? {};
  globalThis.AgentShield.postMessage = postToNode;
  globalThis.AgentShield.sendUserAction = sendUserAction;
  globalThis.agentShieldPostMessage = postToNode;
  globalThis.agentShieldSendUserAction = sendUserAction;
