...
import {
  ...
  type AgentShieldPackageManifest,
...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @agent-shield/voice-call -> voice-call).
...
export function discoverAgentShieldPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".agent-shield", "extensions")];
