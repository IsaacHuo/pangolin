...
export const normalizePluginsConfig = (
  config?: AgentShieldConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: AgentShieldConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: AgentShieldConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: AgentShieldConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
