...
// Channel-specific targets/identity/normalize imports removed
...
// Slack session resolution removed
...
// Discord session resolution removed

// Telegram session resolution removed

// WhatsApp session resolution removed

// Signal session resolution removed

// iMessage session resolution removed
...
export async function resolveOutboundSessionRoute(
  ...
  switch (params.channel) {
    // Slack, Discord, Telegram, WhatsApp, Signal, iMessage cases removed
    case "matrix":
