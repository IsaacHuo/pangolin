...
const CORE_PACKAGE_NAMES = new Set(["pangolin", "agent-shield"]);
...
export async function resolveAgentShieldPackageRoot(opts) {
...
export function resolveAgentShieldPackageRootSync(opts) {
    for (const candidate of buildCandidates(opts)) {
