...
export function applyOpenrouterProviderConfig(cfg: AgentShieldConfig): AgentShieldConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: AgentShieldConfig): AgentShieldConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: AgentShieldConfig): AgentShieldConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: AgentShieldConfig): AgentShieldConfig {
...
export function applyMoonshotConfig(cfg: AgentShieldConfig): AgentShieldConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: AgentShieldConfig): AgentShieldConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: AgentShieldConfig): AgentShieldConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: AgentShieldConfig): AgentShieldConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: AgentShieldConfig): AgentShieldConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: AgentShieldConfig): AgentShieldConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: AgentShieldConfig): AgentShieldConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: AgentShieldConfig): AgentShieldConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: AgentShieldConfig): AgentShieldConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: AgentShieldConfig): AgentShieldConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: AgentShieldConfig): AgentShieldConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: AgentShieldConfig): AgentShieldConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: AgentShieldConfig): AgentShieldConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: AgentShieldConfig): AgentShieldConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: AgentShieldConfig): AgentShieldConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: AgentShieldConfig): AgentShieldConfig {
...
export function applyQianfanProviderConfig(cfg: AgentShieldConfig): AgentShieldConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: AgentShieldConfig): AgentShieldConfig {
