...
export function applyVercelAiGatewayProviderConfig(cfg: AgentShieldConfig): AgentShieldConfig {
...
export function applyVercelAiGatewayConfig(cfg: AgentShieldConfig): AgentShieldConfig {
