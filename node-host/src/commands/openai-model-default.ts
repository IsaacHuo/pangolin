...
export function applyOpenAIProviderConfig(cfg: AgentShieldConfig): AgentShieldConfig {
...
export function applyOpenAIConfig(cfg: AgentShieldConfig): AgentShieldConfig {
