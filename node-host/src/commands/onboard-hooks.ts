...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.agent-shield.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("agent-shield hooks list")}`,
      `  ${formatCliCommand("agent-shield hooks enable <name>")}`,
      `  ${formatCliCommand("agent-shield hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
