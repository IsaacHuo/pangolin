...
export function summarizeExistingConfig(config: AgentShieldConfig): string {
  const rows: string[] = [];
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.agent-shield.ai/gateway/remote",
    "https://docs.agent-shield.ai/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
