...
export function applyOpencodeZenProviderConfig(cfg: AgentShieldConfig): AgentShieldConfig {
...
export function applyOpencodeZenConfig(cfg: AgentShieldConfig): AgentShieldConfig {
