...
type PromptDefaultModelResult = { model?: string; config?: AgentShieldConfig };
...
function resolveConfiguredModelRaw(cfg: AgentShieldConfig): string {
...
function resolveConfiguredModelKeys(cfg: AgentShieldConfig): string[] {
...
export function applyPrimaryModel(cfg: AgentShieldConfig, model: string): AgentShieldConfig {
...
export function applyModelAllowlist(cfg: AgentShieldConfig, models: string[]): AgentShieldConfig {
  const defaults = cfg.agents?.defaults;
