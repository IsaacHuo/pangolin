...
function resolveDefaultAccountId(cfg: AgentShieldConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: AgentShieldConfig): boolean {
...
export function summarizeBindings(cfg: AgentShieldConfig, bindings: AgentBinding[]): string[] {
