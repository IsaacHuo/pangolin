...
export function applyLitellmProviderConfig(cfg: AgentShieldConfig): AgentShieldConfig {
...
export function applyLitellmConfig(cfg: AgentShieldConfig): AgentShieldConfig {
