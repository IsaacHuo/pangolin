...
export async function statusCommand(
  ...
  runtime.log(theme.heading("AgentShield status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("agent-shield security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("agent-shield security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.agent-shield.ai/faq");
  runtime.log("Troubleshooting: https://docs.agent-shield.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("agent-shield status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("agent-shield logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("agent-shield status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("agent-shield gateway probe")}`);
  }
}
