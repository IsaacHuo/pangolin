...
export function applyMinimaxProviderConfig(cfg: AgentShieldConfig): AgentShieldConfig {
...
export function applyMinimaxConfig(cfg: AgentShieldConfig): AgentShieldConfig {
